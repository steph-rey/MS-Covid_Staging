...
## Description
This file summarizes the data, creates descriptive tables for the continuous and categorical variables, and generates plots to show the distrbution of length of stay (LOS) by admission stage.

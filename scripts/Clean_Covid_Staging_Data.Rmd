...
## Description
This file cleans the demographics and daily covid staging data (`dm_stg_clean_11.08.2021.csv`).
...
df <- df %>% 
  ...
  select(-c(end_in_death, death_date, DEATH))
```
...
# Preview final dataset and save as csv file 
